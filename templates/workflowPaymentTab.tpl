{**
 * plugins/paymethod/paystack/templates/workflowPaymentTab.tpl
 *
 * Copyright (c) 2026 Francis Kipruto
 * Distributed under the GNU GPL v3. For full terms see the file LICENSE.
 *
 * Payment tab on the submission workflow / author dashboard.
 * Shown after review when publication fees are enabled.
 *}
<tab id="paystackPayment" label="{translate key="plugins.paymethod.paystack.workflow.tab"}">
